...
export const products = [
  ...
  },
  {
    ...
    description:
      "Onions are a versatile culinary staple, known for their pungent flavor and distinctive aroma. Grown naturally in the nutrient-rich soils of India, they are available in red, white, and yellow varieties. Onions add depth and flavor to a wide range of dishes, including curries, soups, and salads. They are also used as a base for sauces and gravies. With a shelf life of 2 to 3 weeks under proper storage conditions, these bulbs maintain their freshness and quality. Onions are a must-have ingredient in kitchens worldwide, enhancing the taste and aroma of any recipe.",
  },
  {
    id: "potato",
    name: "Potato",
